...
<body>
	...
	<div id="edit_btn">
		<input type="reset" value="초기화" id="edit_reset_btn"> 
		<input type="button" value="목록" id="edit_content_btn" onclick="location.href='list.jsp'"> 
		<input type="submit" value="작성완료" id="edit_update_btn">
	</div>
	</form>
